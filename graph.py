...
def barplot(data, label1, label2):
    """This function plots the bar graph"""
...
def Co2_data_mean():
    """This function is used for calculating the Co2 emission"""

    data1, data2 = read_file(
        "C:\\Users\\user\\Desktop\\asgmnt 2\\CO2 Emission metric tons per capita.xls")
    ...
    mean = cleaned_data[['Estonia', 'Finland',
                         'India', 'Japan', 'Mauritius']].mean()
    return mean
...
Energy_data, Energy_data1 = read_file(
    "C:\\Users\\user\\Desktop\\asgmnt 2\\Enery Use.xls")
Energy_data = filter_bar_plot(Energy_data)
Co2_data, Co2_data1 = read_file(
    "C:\\Users\\user\\Desktop\\asgmnt 2\\CO2 Emission metric tons per capita.xls")
Co2_data = filter_bar_plot(Co2_data)

power_data, power_data1 = read_file(
    "C:\\Users\\user\\Desktop\\asgmnt 2\\Electric power consumption.xls")
power_data = filter_line_data(power_data)
Population_data, Population_data1 = read_file(
    "C:\\Users\\user\\Desktop\\asgmnt 2\\Total population.xls")
